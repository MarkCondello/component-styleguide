...
@section('content')
    <div >
        ...
        <h3>Demo</h3>
        {{-- <div class="demo">
          <datepicker-wrapper :value="{{ json_encode(Carbon\Carbon::now()->format('d/m/Y')) }}"   :is-form-input="true" name="expected_delivery"></datepicker-wrapper>
      </div> --}}
        <div class="demo">
    ...
    >
        ...
        <p>The date format for the date picker us 'd/m/Y'.</p>
        <small>single date items</small>
        <code-block code-content='{{ json_encode(Carbon\Carbon::now()->format('d/m/Y')) }}'></code-block>
        <small>date ranges</small>
        <code-block code-content='{{ json_encode([Carbon\Carbon::now()->format('d/m/Y'), Carbon\Carbon::now()->addDays(7)->format('d/m/Y')]) }}'></code-block>
        <hr>
